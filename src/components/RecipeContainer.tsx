  ...
  return (
    <div>
      <div className="flex justify-between">
        <h2 className="text-3xl font-semibold mb-5">Desserts</h2>
        <svg
      ...
      {state &&  <div className="bg-[#fff] px-4 py-2 h-[300px] rounded-xl md:hidden">
      <h2 className="text-[#cf5353] font-semibold text-xl">Your Cart (0)</h2>
      <div className="flex flex-col justify-center items-center mt-10">
        ...
        <p className="text-[#944]">Your added items will be appear here</p>
